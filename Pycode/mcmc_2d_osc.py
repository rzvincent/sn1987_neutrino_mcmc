...
path_str = '2d_'+ 'm' + file_str + '_5e5_p32_osc'
...
def log_likelihood_K(theta):
    ...
    if kx:
        ...
        part1_K = df.gl3_integrate(SignalRate_2d.SR_K, ranges_K, precision, args=args_list)
...
def log_likelihood_I(theta):
    ...
    if ix:
        ...
        part1_I = df.gl3_integrate(SignalRate_2d.SR_I, ranges_I, precision, args=args_list)
...
def log_likelihood_B(theta):
    ...
    if bx:
        ...
        part1_B = df.gl3_integrate(SignalRate_2d.SR_B, ranges_B, precision, args=args_list)
